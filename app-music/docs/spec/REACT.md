...
│   │       │   └── index.module.css
│   │       └── index.ts
│   ├── models/                          # Modelos/tipos compartidos en components
│   │   ├── User.ts
│   │   ├── Card.ts
│   │   └── index.ts                     # Barrel file
│   └── index.ts                         # Barrel file
...
│   │   └── components/
│   │       └── index.ts
│   ├── models/                          # Modelos/tipos compartidos en pages
│   │   ├── PageState.ts
│   │   ├── PageProps.ts
│   │   └── index.ts                     # Barrel file
│   └── index.ts                         # Barrel file
...
- **Tipos**: `ComponentName.types.ts` → `UserCard.types.ts`
...
└── UserCard.types.ts   # Tipos (opcional, si es complejo)
```
...
└── components/
    ...
    │   ├── index.tsx
    │   ├── index.module.css
    │   └── UserCardHeader.types.ts
    ├── UserCardBody/
    │   ├── index.tsx
    │   ├── index.module.css
    │   └── UserCardBody.types.ts
    └── index.ts                # Barrel file
```
...
Modelos son tipos/interfaces que se comparten dentro de un nivel (components, pages, shared). Crear carpeta `models/` en cada nivel:

**components/models/User.ts**
...
- Tipos locales en `ComponentName.types.ts` si es específico del componente
...
- **Crear carpeta `models/`** en cada nivel (components, pages, shared) para tipos compartidos
